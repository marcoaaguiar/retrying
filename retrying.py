...
def _retry_if_exception_of_type(retryable_types: Union[Type[BaseException], Tuple[Type[BaseException], ...]]) -> Callable[[BaseException], bool]:
...
class Retrying:
    def __init__(
        self,
        stop: Optional[Union[str, Callable[[int, int], bool]]] = None,
        wait: Optional[Union[str, Callable[[int, int], int]]] = None,
        ...
        retry_on_exception: Optional[Union[Callable[[BaseException], bool], Tuple[Type[BaseException], ...]]] = None,
        retry_on_result: Optional[Callable[[Any], bool]] = None,
        wrap_exception: bool = False,
        stop_func: Optional[Callable[[int, int], bool]] = None,
        wait_func: Optional[Callable[[int, int], int]] = None,
